    ...
    <section className="w-full py-20 bg-gray-50">
      <div className="container px-4 md:px-6">
        <div className="text-center mb-12">
          <span className="text-[#B8860B] text-xl font-semibold">Welcome</span>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="hover:translate-x-2 transition-transform">
              <h3 className="text-2xl font-bold mb-4 text-[#B8860B]">Vision</h3>
            ...
            <div className="hover:translate-x-2 transition-transform">
              <h3 className="text-2xl font-bold mb-4 text-[#B8860B]">Mission</h3>
              <p className="text-gray-600">
