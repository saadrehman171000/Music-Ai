    ...
    <section className="w-full py-20 bg-gradient-to-r from-amber-50 to-amber-100/50">
      <div className="container px-4 md:px-6">
        <div className="text-center space-y-4">
          ...
          <Button className="bg-gradient-to-r from-amber-500 to-amber-700 hover:from-amber-600 hover:to-amber-800 text-white px-8 py-6 text-lg shadow-lg hover:shadow-amber-500/25 transition-all duration-300">
